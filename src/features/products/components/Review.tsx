      ...
      />
        {profileImage ? (
          ...
          />
            ...
            <div className="ring-purple-100 ring-4  w-16 text-3xl h-14 bg-gradient-to-br from-[#44155B] to-[#E42F1C] rounded-full flex items-center justify-center text-white font-bold">
